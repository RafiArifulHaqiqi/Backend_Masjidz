...
# INITIALIZATION
# ==============================================================================
# Mengambil data JSON dari Environment Variable Railway
...
if firebase_env:
    ...
    # Pastikan letak path-nya sudah benar
...
core = midtransclient.CoreApi(
    is_production=False,
    server_key='MIDTRANS_SERVER_KEY',  # Ganti dengan server key Midtrans kamu
...
async def create_donation(request: DonasiRequest):
    try:
        MIDTRANS_SERVER_KEY = "MIDTRANS_SERVER_KEY"  # Ganti dengan server key Midtrans kamu
